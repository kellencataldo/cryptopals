...
void test_convertHexToBase64(void) {
    ...
    const char* b64String_1 = convertHexToBase64(hexString_1);
    ...
    const char* b64String_2 = convertHexToBase64(hexString_2);
    ...
    const char* b64String_3 = convertHexToBase64(hexString_3);
